...
const fallbackProducts = [
  { id: 1, name: "Gray Iron Machine Tool Base", category: { id: 1, name: "Gray Iron", sort_order: 1, product_count: 0 }, material: "HT200 / HT300", weight_range: "50-5000 kg", standard: "GB/T 9439", cover_image: "https://images.unsplash.com/photo-1763669029286-7f1662eb921d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtZXRhbCUyMGNhc3RpbmclMjBmb3VuZHJ5JTIwaW5kdXN0cmlhbCUyMGZhY3Rvcnl8ZW58MXx8fHwxNzc3NDcxNTU5fDA&ixlib=rb-4.1.0&q=80&w=600", images: [], tag: "Hot", is_featured: true, sort_order: 1, created_at: "" },
  { id: 2, name: "Ductile Iron Crankshaft", category: { id: 2, name: "Ductile Iron", sort_order: 2, product_count: 0 }, material: "QT500-7 / QT600-3", weight_range: "5-500 kg", standard: "GB/T 1348", cover_image: "https://images.unsplash.com/photo-1682834187151-682c7420e88b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzdGVlbCUyMGNhc3RpbmclMjBtb2x0ZW4lMjBtZXRhbCUyMG1hbnVmYWN0dXJpbmd8ZW58MXx8fHwxNzc3NDcxNTU5fDA&ixlib=rb-4.1.0&q=80&w=600", images: [], tag: "Premium", is_featured: true, sort_order: 2, created_at: "" },
  { id: 3, name: "Cast Steel Gearbox Housing", category: { id: 3, name: "Cast Steel", sort_order: 3, product_count: 0 }, material: "ZG230-450 / ZG340-640", weight_range: "10-2000 kg", standard: "GB/T 11352", cover_image: "https://images.unsplash.com/photo-1767739791246-9f832345f8f1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpbmR1c3RyaWFsJTIwbWV0YWwlMjBwYXJ0cyUyMG1hY2hpbmVyeSUyMGVxdWlwbWVudHxlbnwxfHx8fDE3Nzc0NzE1NTl8MA&ixlib=rb-4.1.0&q=80&w=600", images: [], tag: "", is_featured: false, sort_order: 3, created_at: "" },
  { id: 4, name: "Aluminum Alloy Pump Body", category: { id: 4, name: "Aluminum Alloy", sort_order: 4, product_count: 0 }, material: "A356 / ZL101A", weight_range: "0.5-50 kg", standard: "GB/T 1173", cover_image: "https://images.unsplash.com/photo-1748640857973-93524ef0fe7d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcmVjaXNpb24lMjBlbmdpbmVlcmluZyUyMHdvcmtzaG9wJTIwQ05DJTIwbWFjaGluaW5nfGVufDF8fHx8MTc3NzQ3MTU2MHww&ixlib=rb-4.1.0&q=80&w=600", images: [], tag: "New", is_featured: true, sort_order: 4, created_at: "" },
  { id: 5, name: "Investment Cast Turbine Blade", category: { id: 5, name: "Investment Casting", sort_order: 5, product_count: 0 }, material: "IN718 / 304 Stainless Steel", weight_range: "0.1-20 kg", standard: "ASTM A352", cover_image: "https://images.unsplash.com/photo-1764185800646-f75f7e16e465?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmYWN0b3J5JTIwcHJvZHVjdGlvbiUyMGxpbmUlMjBtYW51ZmFjdHVyaW5nJTIwcGxhbnR8ZW58MXx8fHwxNzc3NDcxNTYwfDA&ixlib=rb-4.1.0&q=80&w=600", images: [], tag: "", is_featured: false, sort_order: 5, created_at: "" },
  { id: 6, name: "Gray Iron Brake Drum", category: { id: 1, name: "Gray Iron", sort_order: 1, product_count: 0 }, material: "HT250", weight_range: "3-30 kg", standard: "GB/T 9439", cover_image: "https://images.unsplash.com/photo-1763669029286-7f1662eb921d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtZXRhbCUyMGNhc3RpbmclMjBmb3VuZHJ5JTIwaW5kdXN0cmlhbCUyMGZhY3Rvcnl8ZW58MXx8fHwxNzc3NDcxNTU5fDA&ixlib=rb-4.1.0&q=80&w=600", images: [], tag: "Hot", is_featured: true, sort_order: 6, created_at: "" },
];
            ...
            {products.map((product, i) => (
              ...
              >
                ...
                <div className="p-4 sm:p-5">
                  <div className="text-xs text-[#f97316] font-medium mb-1">{product.category ? en(product.category) : ""}</div>
